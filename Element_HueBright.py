...
class ElementHueBright:
    ...
    def apply_curve(self, image, curve_data, preview_size, frame_index, output_mode, unique_id):
        ...
        print(
            f"[ElementHueBright][apply_curve] input_device={image.device}, input_dtype={image.dtype}, "
...
async def huebright_live_preview(request):
    try:
        ...
        print(
            f"[ElementHueBright][live_preview] cache_device={image.device}, cache_dtype={image.dtype}, "
