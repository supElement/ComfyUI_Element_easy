...
app.registerExtension({
    name: "Element_easy.HueSat",
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name !== "ElementHueSat") return;
        ...
        try {
            ...
            console.warn("[HueSat] nodeData hide patch failed:", e);
        }
        ...
        nodeType.prototype.onNodeCreated = function () {
            ...
            titleSpan.innerText = "Hue vs Saturation";
            ...
            const updateLivePreview = (isDragging = false) => {
                ...
                (async () => {
                    try {
                        const response = await api.fetchApi("/element_huesat/live_preview", {
                            method: "POST",
